...
import com.etiya.northwind.core.utilities.exeptions.BusinessException;
import com.etiya.northwind.core.utilities.result.ErrorDataResult;
...
public class NorthwindApplication {
	...
	public ErrorDataResult<Object> handleBusinessExceptions(BusinessException businessException){
		ErrorDataResult<Object> error = new ErrorDataResult<Object>(businessException.getMessage(), "BusinessExceptions");
		return error;
	}
